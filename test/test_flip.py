...
# Lift fast!
env.velocity_control([0, 0.2, 0], [-3.0, 0, 0], numSteps=25, objId=pancake_id)
env.velocity_control([0, 0.2, 0], [0, 0, 0], numSteps=50, objId=pancake_id)

# env.velocity_control([0, 0, 1.5], [0, -2, 0], numSteps=100, objId=pancake_id)

# # for step in range(20):
# #     env.velocity_control([-0.01, 0, 0.01], [0, -1 - step * 0.1, 0],
# #                          numSteps=step)

# Move away
# env.velocity_control([0, -0.5, -0.2], [0, 2, 0],
#                      numSteps=100,
#                      objId=pancake_id)
env.velocity_control([0.0, 0, 0.0], [0, 0, 0], numSteps=1000, objId=pancake_id)
