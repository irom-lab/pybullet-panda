...
class GraspBanditEq():
    ...
    def build_network(self, cfg, build_optimizer=True, verbose=True, poem=False):
        img_size = cfg.img_h
        assert img_size == cfg.img_w
        self.decoder = FCN(inner_channels=cfg.inner_channels,
        ...
        # POEM encoder
        self.encoder = FCN(inner_channels=cfg.inner_channels,
                    in_channels=cfg.in_channels,
                    out_channels=cfg.out_channels,
                    img_size=img_size).to(self.device)

        # POEM latent policy
        self.policy = FCN(inner_channels=cfg.inner_channels,
                    in_channels=cfg.in_channels,
                    out_channels=cfg.out_channels,
                    img_size=img_size).to(self.device)
    ...
    def forward(self, state, append=None, flag_random=False):
        ...
        # TODO: pass through encoder and latent policy
    ...
    def update(self, batch):
        ...
        # TODO: Decoder training, check accuracy...
